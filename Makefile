...
generate-openapi-spec: dependencies
	...
	cp ./src/Api/bin/Release/net10.0/appsettings.json .
	dotnet swagger tofile --output openapi.json ./src/Api/bin/Release/net10.0/Defra.TradeImportsDataApi.Api.dll v1
	rm appsettings.json
