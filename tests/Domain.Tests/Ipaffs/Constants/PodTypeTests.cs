...
public class PodTypeTests
{
    ...
    {
        PodType.IsConsignee(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsDestination(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsExporter(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsImporter(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsCharity(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsCommercialTransporter(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsCommercialTransporterUserAdded(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsPrivateTransporter(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsTemporaryAddress(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsPremisesOfOrigin(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsOrganisationBranchAddress(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsPacker(status).Should().Be(expected);
    }
    ...
    {
        PodType.IsPod(status).Should().Be(expected);
    }
}
