...
public class MeansOfTransportFromEntryPointTypeTests
{
    [Theory]
    ...
    {
        MeansOfTransportFromEntryPointType.IsAeroplane(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsRoadVehicle(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsRailwayWagon(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsShip(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsOther(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsRoadVehicleAeroplane(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsShipRailwayWagon(status).Should().Be(expected);
    }
    ...
    {
        MeansOfTransportFromEntryPointType.IsShipRoadVehicle(status).Should().Be(expected);
    }
}
