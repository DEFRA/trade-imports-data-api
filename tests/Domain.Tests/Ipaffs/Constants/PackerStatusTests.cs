...
public class PackerStatusTests
{
    [Theory]
    ...
    {
        PackerStatus.IsApproved(status).Should().Be(expected);
    }
    ...
    {
        PackerStatus.IsNonapproved(status).Should().Be(expected);
    }
    ...
    {
        PackerStatus.IsSuspended(status).Should().Be(expected);
    }
}
