...
public class EconomicOperatorTypeTests
{
    [Theory]
    ...
    {
        EconomicOperatorType.IsConsignee(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsDestination(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsExporter(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsImporter(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsCharity(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsCommercialTransporter(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsCommercialTransporterUserAdded(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsPrivateTransporter(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsTemporaryAddress(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsPremisesOfOrigin(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsOrganisationBranchAddress(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsPacker(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorType.IsPod(status).Should().Be(expected);
    }
}
