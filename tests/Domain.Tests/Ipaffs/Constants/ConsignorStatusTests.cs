...
public class ConsignorStatusTests
{
    [Theory]
    ...
    {
        ConsignorStatus.IsApproved(status).Should().Be(expected);
    }
    ...
    {
        ConsignorStatus.IsNonapproved(status).Should().Be(expected);
    }
    ...
    {
        ConsignorStatus.IsSuspended(status).Should().Be(expected);
    }
}
