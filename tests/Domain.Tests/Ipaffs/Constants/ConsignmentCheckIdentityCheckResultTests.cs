...
public class ConsignmentCheckIdentityCheckResultTests
{
    [Theory]
    ...
    {
        ConsignmentCheckIdentityCheckResult.IsSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckIdentityCheckResult.IsSatisfactoryFollowingOfficialIntervention(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckIdentityCheckResult.IsNotSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckIdentityCheckResult.IsNotDone(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckIdentityCheckResult.IsDerogation(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckIdentityCheckResult.IsNotSet(status).Should().Be(expected);
    }
}
