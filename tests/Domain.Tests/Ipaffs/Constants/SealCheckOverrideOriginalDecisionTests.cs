...
public class SealCheckOverrideOriginalDecisionTests
{
    [Theory]
    ...
    {
        SealCheckOverrideOriginalDecision.IsRequired(status).Should().Be(expected);
    }
    ...
    {
        SealCheckOverrideOriginalDecision.IsInconclusive(status).Should().Be(expected);
    }
    ...
    {
        SealCheckOverrideOriginalDecision.IsNotRequired(status).Should().Be(expected);
    }
}
