...
public class ConsignmentCheckLaboratoryCheckResultTests
{
    [Theory]
    ...
    {
        ConsignmentCheckLaboratoryCheckResult.IsSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckLaboratoryCheckResult.IsSatisfactoryFollowingOfficialIntervention(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckLaboratoryCheckResult.IsNotSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckLaboratoryCheckResult.IsNotDone(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckLaboratoryCheckResult.IsDerogation(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckLaboratoryCheckResult.IsNotSet(status).Should().Be(expected);
    }
}
