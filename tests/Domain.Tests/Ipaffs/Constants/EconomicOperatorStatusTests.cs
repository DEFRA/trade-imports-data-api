...
public class EconomicOperatorStatusTests
{
    [Theory]
    ...
    {
        EconomicOperatorStatus.IsApproved(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorStatus.IsNonapproved(status).Should().Be(expected);
    }
    ...
    {
        EconomicOperatorStatus.IsSuspended(status).Should().Be(expected);
    }
}
