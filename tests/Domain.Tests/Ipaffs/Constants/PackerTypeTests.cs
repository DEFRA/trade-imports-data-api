...
public class PackerTypeTests
{
    ...
    {
        PackerType.IsConsignee(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsDestination(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsExporter(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsImporter(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsCharity(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsCommercialTransporter(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsCommercialTransporterUserAdded(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsPrivateTransporter(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsTemporaryAddress(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsPremisesOfOrigin(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsOrganisationBranchAddress(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsPacker(status).Should().Be(expected);
    }
    ...
    {
        PackerType.IsPod(status).Should().Be(expected);
    }
}
