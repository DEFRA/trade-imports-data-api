...
public class ImporterTypeTests
{
    [Theory]
    ...
    {
        ImporterType.IsConsignee(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsDestination(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsExporter(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsImporter(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsCharity(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsCommercialTransporter(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsCommercialTransporterUserAdded(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsPrivateTransporter(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsTemporaryAddress(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsPremisesOfOrigin(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsOrganisationBranchAddress(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsPacker(status).Should().Be(expected);
    }
    ...
    {
        ImporterType.IsPod(status).Should().Be(expected);
    }
}
