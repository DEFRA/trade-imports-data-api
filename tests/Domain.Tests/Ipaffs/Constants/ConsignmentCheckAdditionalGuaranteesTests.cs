...
public class ConsignmentCheckAdditionalGuaranteesTests
{
    [Theory]
    ...
    {
        ConsignmentCheckAdditionalGuarantees.IsSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckAdditionalGuarantees.IsSatisfactoryFollowingOfficialIntervention(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckAdditionalGuarantees.IsNotSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckAdditionalGuarantees.IsNotDone(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckAdditionalGuarantees.IsDerogation(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckAdditionalGuarantees.IsNotSet(status).Should().Be(expected);
    }
}
