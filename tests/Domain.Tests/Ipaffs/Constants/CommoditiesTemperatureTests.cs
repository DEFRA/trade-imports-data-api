...
public class CommoditiesTemperatureTests
{
    [Theory]
    ...
    {
        CommoditiesTemperature.IsAmbient(status).Should().Be(expected);
    }
    ...
    {
        CommoditiesTemperature.IsChilled(status).Should().Be(expected);
    }
    ...
    {
        CommoditiesTemperature.IsFrozen(status).Should().Be(expected);
    }
}
