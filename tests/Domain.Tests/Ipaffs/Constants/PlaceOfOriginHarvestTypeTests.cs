...
public class PlaceOfOriginHarvestTypeTests
{
    [Theory]
    ...
    {
        PlaceOfOriginHarvestType.IsConsignee(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsDestination(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsExporter(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsImporter(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsCharity(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsCommercialTransporter(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsCommercialTransporterUserAdded(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsPrivateTransporter(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsTemporaryAddress(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsPremisesOfOrigin(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsOrganisationBranchAddress(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsPacker(status).Should().Be(expected);
    }
    ...
    {
        PlaceOfOriginHarvestType.IsPod(status).Should().Be(expected);
    }
}
