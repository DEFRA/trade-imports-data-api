...
public class ConsignmentCheckWelfareCheckTests
{
    [Theory]
    ...
    {
        ConsignmentCheckWelfareCheck.IsSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckWelfareCheck.IsSatisfactoryFollowingOfficialIntervention(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckWelfareCheck.IsNotSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckWelfareCheck.IsNotDone(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckWelfareCheck.IsDerogation(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckWelfareCheck.IsNotSet(status).Should().Be(expected);
    }
}
