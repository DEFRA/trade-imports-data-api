...
public class DecisionNotAcceptableActionQuarantineImposedReasonTests
{
    [Theory]
    ...
    {
        DecisionNotAcceptableActionQuarantineImposedReason.IsOther(status).Should().Be(expected);
    }
}
