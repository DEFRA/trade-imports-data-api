...
public class ConsignmentCheckDocumentCheckResultTests
{
    [Theory]
    ...
    {
        ConsignmentCheckDocumentCheckResult.IsSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckDocumentCheckResult.IsSatisfactoryFollowingOfficialIntervention(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckDocumentCheckResult.IsNotSatisfactory(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckDocumentCheckResult.IsNotDone(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckDocumentCheckResult.IsDerogation(status).Should().Be(expected);
    }
    ...
    {
        ConsignmentCheckDocumentCheckResult.IsNotSet(status).Should().Be(expected);
    }
}
