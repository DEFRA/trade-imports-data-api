...
public class ConsigneeTypeTests
{
    [Theory]
    ...
    {
        ConsigneeType.IsConsignee(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsDestination(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsExporter(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsImporter(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsCharity(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsCommercialTransporter(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsCommercialTransporterUserAdded(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsPrivateTransporter(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsTemporaryAddress(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsPremisesOfOrigin(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsOrganisationBranchAddress(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsPacker(status).Should().Be(expected);
    }
    ...
    {
        ConsigneeType.IsPod(status).Should().Be(expected);
    }
}
