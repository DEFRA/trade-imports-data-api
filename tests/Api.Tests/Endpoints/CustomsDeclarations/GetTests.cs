...
public class GetTests : EndpointTestBase, IClassFixture<WireMockContext>
{
    ...
    public async Task Get_WhenGenerating_GetTests_DomainExample_ShouldSerialize()
    {
        ...
        await File.WriteAllTextAsync("Get_WhenAutoGenerated_ShouldReturn.json", serialized);
    ...
    public async Task Get_WhenReturningDomainExample_ShouldBeCorrectJson()
    {
        ...
        var body = GetBody("GetTests_DomainExample.json");
    ...
    {
        using var stream = typeof(GetTests).Assembly.GetManifestResourceStream($"{GetScenarioPrefix()}{fileName}");
    ...
    private static string GetScenarioPrefix() => $"{typeof(GetTests).Namespace}.";
}
